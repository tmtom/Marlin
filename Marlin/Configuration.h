...
#define Z_PROBE_LOW_POINT          -3 // Farthest distance below the trigger-point to go before stopping (has to be <=0; orig 0)
...
//#define MIN_SOFTWARE_ENDSTOPS alt TM
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // X_PROBE_OFFSET_FROM_EXTRUDER - (-X_MIN_POS) = 66-38 = 28
  #define LEFT_PROBE_BED_POSITION 28
  
  // X_BED_SIZE - LEFT_PROBE_BED_POSITION = 220 - 28 = 192
  #define RIGHT_PROBE_BED_POSITION 192
  
  // we can reach anywhere so use the same as X
  #define FRONT_PROBE_BED_POSITION LEFT_PROBE_BED_POSITION
  
  // we can reach 217 - 8 so again use the same as X
